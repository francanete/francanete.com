        ...
        <Container className={styles.About}>
          <section>
            ...
            <div className={styles['About__wrapper']}>
              <Image
                ...
                alt="Portrait of Fran Canete, a software developer"
                layout="responsive"
                width={400}
                height={400}
              ...
              <article>
                ...
                <Paragraph>
                  My transition from business to software development has been
                  an inspiring journey to fulfil this purpose of creating
                  products that serve the market, not the other way around.
                </Paragraph>
              </article>
            </div>
          </section>
          <section>
            ...
            <Paragraph>
              ...
              felis eget nunc lobortis mattis. Pellentesque elit eget gravida
              cum sociis natoque penatibus. Pellentesque habitant morbi
              tristique senectus et netus. Ut ornare lectus sit amet est
              placerat in egestas.
            </Paragraph>
          </section>
          <section>
