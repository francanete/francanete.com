...
export const projects: Project[] = [
    {
        ...
        title: "Planitly",
        description:
            "AI-powered travel planning platform that creates personalized vacation itineraries in seconds",
        projectLogo: "/planitly-logo.png",
        status: "LIVE IN PRODUCTION",
        keyFeatures: [
            "AI-generated personalized travel itineraries using OpenAI",
            "TripAdvisor integration for real location data and reviews",
            "Customizable day-by-day itinerary builder with drag-and-drop",
            "Public travel plan sharing with custom URLs",
            "Stripe payment integration with free tier and founder's pass",
            "Background job processing with Inngest for async AI generation",
            "Travel guides with MDX content",
