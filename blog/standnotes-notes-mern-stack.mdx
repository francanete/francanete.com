---
title: StandNotes — Daily standup notes organiser MERN
type: project
repositoryName: standnotes
category:
  - react
  - turborepo
  - typescript
...
technologies:
  - React
  - Typescript
excerpt: Using MERN stack to create a daily standup notes organiser app. On top of that, the app uses Turborepo to manage the monorepo and React Query as a state management tool.
---
